      ...
      for (auto const& Q2 : Q2rangelims)
      {
        ...
        for (auto const& x : xrangelims)
        {
          for (auto const& z : zrangelims)
          {
            ...
            emit << YAML::Flow << YAML::BeginMap << YAML::Key << "name" << YAML::Value << "target_isoscalarity" << YAML::Key << "value" << YAML::Value << "0.6667" << YAML::EndMap;
      ...
      for (auto const& Q2 : Q2rangelims)
      {
        ...
        for (auto const& x : xrangelims)
        {
          for (auto const& z : zrangelims)
          {
            ...
            emit << YAML::Flow << YAML::BeginMap << YAML::Key << "name" << YAML::Value << "observable" << YAML::Key << "value" << YAML::Value << "FUUT" << YAML::EndMap;
            emit << YAML::Flow << YAML::BeginMap << YAML::Key << "name" << YAML::Value << "target_isoscalarity" << YAML::Key << "value" << YAML::Value << "0.6667" << YAML::EndMap;
            emit << YAML::Flow << YAML::BeginMap << YAML::Key << "name" << YAML::Value << "hadron" << YAML::Key << "value" << YAML::Value << "KA" << YAML::EndMap;
            emit << YAML::Flow << YAML::BeginMap << YAML::Key << "name" << YAML::Value << "charge" << YAML::Key << "value" << YAML::Value << charge << YAML::EndMap;
            //emit << YAML::Flow << YAML::BeginMap << YAML::Key << "name" << YAML::Value << "beam" << YAML::Key << "value" << YAML::Value << rows[0].Eb << YAML::EndMap;
            //emit << YAML::Flow << YAML::BeginMap << YAML::Key << "name" << YAML::Value << "hadron" << YAML::Key << "value" << YAML::Value << rows[0].had << YAML::EndMap;
            emit << YAML::Flow << YAML::BeginMap << YAML::Key << "name" << YAML::Value << "prefactor" << YAML::Key << "value" << YAML::Value << 1 << YAML::EndMap;
...
namespace NangaParbat
{
  ...
  //_________________________________________________________________________________
  std::string PreprocessSoLID_22(std::string const& RawDataPath, std::string const& ProcessedDataPath)
  {
    std::cout << "Processing SoLID 22GeV Pion projection ..." << std::endl;
    ...
    // Vector of tables to process
    const std::vector<std::string> tables = {"numbers_x1_pip_22_He3.txt","numbers_x1_pim_22_He3.txt","numbers_x2_pip_22_He3.txt","numbers_x2_pim_22_He3.txt","numbers_x3_pip_22_He3.txt","numbers_x3_pim_22_He3.txt"};
    ...
    for (auto const& tab : tables)
    {
      ...
      // Vs ( = sqrt(2*M*E) for fixed target experiments)
      double Vs;
      if(tab=="numbers_x1_pip_22_He3.txt" or tab=="numbers_x1_pim_22_He3.txt"){
        //std::cout<<" check condition 1"<<std::endl;
        // Initialize naming map for the Q-integration ranges (the first element is for the name of the output data file)
        Q2rangelims = {{"_22_Q2_2_4", {2.0, 4.0}}, {"_22_Q2_4.0_6.0", {4.0, 6.0}}, {"_22_Q2_6.0_10", {6.0, 10.0}}};
        xrangelims = {{"_x_0_0.25", {0.00001, 0.25}}};
        zrangelims = {{"_z_0.3_0.35", {0.3, 0.35}}, {"_z_0.35_0.40", {0.350, 0.40}},{"_z_0.40_0.5", {0.4, 0.5}}, {"_z_0.5_0.6",{0.5,0.6}},{"_z_0.6_0.7",{0.6,0.7}}};

        // Vs ( = sqrt(2*M*E) for fixed target experiments, here E = 11 GeV)
        Vs = 6.424;
        //const double Vs = 28.635642;
      }
      else if(tab=="numbers_x2_pip_22_He3.txt" or tab=="numbers_x2_pim_22_He3.txt"){
        //std::cout<<" check condition 2"<<std::endl;
        // Initialize naming map for the Q-integration ranges (the first element is for the name of the output data file)
        Q2rangelims = {{"_22_Q2_4.0_6.0", {4.0, 6.0}}, {"_22_Q2_6.0_10.0", {6.0, 10.0}},{"_22_Q2_10.0_20.0",{10.0,20.0}}};
        xrangelims = {{"_x_0.25_0.5", {0.25, 0.5}}};
        zrangelims = {{"_z_0.3_0.35", {0.3, 0.35}}, {"_z_0.35_0.40", {0.350, 0.40}},{"_z_0.40_0.5", {0.4, 0.5}}, {"_z_0.5_0.6",{0.5,0.6}},{"_z_0.6_0.7",{0.6,0.7}}};
      ...
      else if(tab=="numbers_x3_pip_22_He3.txt" or tab=="numbers_x3_pim_22_He3.txt"){
        //std::cout<<" check condition 2"<<std::endl;
        // Initialize naming map for the Q-integration ranges (the first element is for the name of the output data file)
        Q2rangelims = {{"_22_Q2_6.0_10.0", {6.0, 10.0}},{"_22_Q2_10.0_20.0",{10.0,20.0}}};
        xrangelims = {{"_x_0.5_0.7", {0.5, 0.7}}};
        zrangelims = {{"_z_0.3_0.35", {0.3, 0.35}}, {"_z_0.35_0.40", {0.350, 0.40}},{"_z_0.40_0.5", {0.4, 0.5}}, {"_z_0.5_0.6",{0.5,0.6}},{"_z_0.6_0.7",{0.6,0.7}}};
...
namespace NangaParbat
{
  ...
  //_________________________________________________________________________________
  std::string PreprocessSoLID_22_nosys(std::string const& RawDataPath, std::string const& ProcessedDataPath)
  {
    std::cout << "Processing SoLID 22GeV Pion projection ..." << std::endl;
